...
$cvvz5 = multiexplode(array(":", "/", " ", "|"), $cc5)[3];
  ...
  $sendmes = "https://api.telegram.org/bot$botToken/sendMessage?chat_id=".$chatId."&text=<b>CEX CHK ⚡️ - Status - $sat%0A━━━━━━━━━━━━━%0A[ϟ] STATUS: MASS CHECK INITIATED. WAIT...%0A━━━━━━━━━━━━━</b>&reply_to_message_id=".$message_id."&parse_mode=HTML";
  ...
  editMessage($chatId, "<b>CEX CHK ⚡️ - Status - $sat%0A$ccr1</b>",$mes_id);
  ...
  editMessage($chatId, "<b>CEX CHK ⚡️ - Status - $sat%0A$ccr1%0A$ccr2</b>",$mes_id);
  ...
  editMessage($chatId, "<b>CEX CHK ⚡️ - Status - $sat%0A$ccr1%0A$ccr2%0A$ccr3</b>",$mes_id);
  ...
  editMessage($chatId, "<b>CEX CHK ⚡️ - Status - $sat%0A$ccr1%0A$ccr2%0A$ccr3%0A$ccr4</b>",$mes_id);
  ...
  editMessage($chatId, "<b>CEX CHK ⚡️ - Status - $sat%0A$ccr1%0A$ccr2%0A$ccr3%0A$ccr4%0A$ccr5</b>",$mes_id);
    $time_end = microtime(true);
  $execution_time = ($time_end - $time_start);
   editMessage($chatId, "<b>CEX CHK ⚡️ - Status - $sat%0A$ccr1%0A$ccr2%0A$ccr3%0A$ccr4%0A$ccr5%0A━━━━━━━━━━━━━%0A[ϟ] 5 CARDS CHECKED!✅%0A[ϟ] TIME TAKEN: $execution_time's%0A[ϟ] Checked By: @$username%0A[ϟ] UserID: $userId%0A[ϟ] Premium Activated: $stat%0A</b>",$mes_id);
}
}
}